...
import { FormWrapper, Header, SubmitButton, TextButton, NoAccountWrapper } from "../RegistrationForm/RegistrationForm.styled";
  ...
  return (
    <FormWrapper>
        <form onSubmit={handleSubmit(onSubmit)}>
          ...
          <NoAccountWrapper><p>Nie masz jeszcze konta?</p>
<TextButton onClick={()=>setIsLogin(false)}>Zarejestruj się</TextButton></NoAccountWrapper>
